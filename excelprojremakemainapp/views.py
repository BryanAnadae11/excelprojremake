...
def home(request):
	return render(request, 'excelprojremakemainapp/index.html')

def plan(request):
	plans= Plan.objects.all()
	context= {'plans':plans}
	return render(request, 'excelprojremakemainapp/plan.html', context)

def otherpayment(request):
    return render(request, 'excelprojremakemainapp/otherpayment.html')

def about(request):
	return render(request, 'excelprojremakemainapp/company.html')

def renewableEnergy(request):
	return render(request, 'excelprojremakemainapp/renewableEnergy.html')

def financialService(request):
	return render(request, 'excelprojremakemainapp/financialService.html')

def energy(request):
	return render(request, 'excelprojremakemainapp/energy.html')

def portfolioManagement(request):
	return render(request, 'excelprojremakemainapp/portfolioManagement.html')

def financialAdvising(request):
	return render(request, 'excelprojremakemainapp/financialAdvising.html')

def faq(request):
	return render(request, 'excelprojremakemainapp/faq.html')

def services(request):
	return render(request, 'excelprojremakemainapp/services.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				email= user.email
				template= render_to_string('excelprojremakemainapp/otpalert.html', {'otp':otp})
				plain_message= strip_tags(template)
				email_message= EmailMultiAlternatives(
					'Use this OTP code to login to your AlphaOilHedge!',
					template,
	...
	context={}
	return render(request, 'excelprojremakemainapp/signin.html')
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			if str(otp_obj.otp_code) == str(entered_otp) and not otp_obj.is_expired():
				email= user.email
				template= render_to_string('excelprojremakemainapp/loginAlert.html', {'name':user.username})
				plain_message= strip_tags(template)
				email_message= EmailMultiAlternatives(
				...
				return render(request, 'excelprojremakemainapp/verify_otp.html', {'form': form, 'error': 'Invalid or expired OTP'})
	else:
		form = OTPForm()

	return render(request, 'excelprojremakemainapp/verify_otp.html', {'form': form})


def privacy(request):
	return render(request, 'excelprojremakemainapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'excelprojremakemainapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('excelprojremakemainapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('excelprojremakemainapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to AlphaOilHedge',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('excelprojremakemainapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with AlphaOilHedge!",
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'excelprojremakemainapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'excelprojremakemainapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'excelprojremakemainapp/adminpage.html', context)


def terms(request):
	return render(request, 'excelprojremakemainapp/terms.html')


def realestate(request):
	return render(request, 'excelprojremakemainapp/realestate.html')


def crypto(request):
	return render(request, 'excelprojremakemainapp/crypto.html')


def forex(request):
	return render(request, 'excelprojremakemainapp/forex.html')


def nft(request):
	return render(request, 'excelprojremakemainapp/nft.html')


def contact(request):
	return render(request, 'excelprojremakemainapp/contact.html')


def stocks(request):
	return render(request, 'excelprojremakemainapp/stocks.html')


def agriculture(request):
	return render(request, 'excelprojremakemainapp/agriculture.html')


def gold(request):
	return render(request, 'excelprojremakemainapp/gold.html')


def retirement(request):
	return render(request, 'excelprojremakemainapp/retirement.html')
	...
	if request.method=='POST':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.AlphaOilHedge.com/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.AlphaOilHedge.com/dashboard"
			})
			...
			template= render_to_string('excelprojremakemainapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
			except BadHeaderError:
				pass
			return redirect(generated_link)
	context={}
	return render(request, 'excelprojremakemainapp/deposittwo.html', context)
...
def investmentPlans(request):
	plans= Plan.objects.all()
	context= {'plans':plans}
	return render(request, 'excelprojremakemainapp/investmentplans.html', context)
...
def prospectorDeposit(request):
	...
	context= {}
	return render(request, 'excelprojremakemainapp/prospectorDepositForm.html', context)
...
def UpstreamDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'excelprojremakemainapp/UpstreamDeposit.html', context)
...
def PetrolMaxDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'excelprojremakemainapp/PetrolMaxDeposit.html', context)
...
def premiumHedgeDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'excelprojremakemainapp/premiumHedgeDeposit.html', context)
...
def eliteDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'excelprojremakemainapp/eliteDeposit.html', context)
...
def deposit(request):
	...
	if price_amount and pay_currency:
		...
		return redirect(generated_link)
		context={}
	return render(request, 'excelprojremakemainapp/deposit.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
	...
	context={}
	return render(request, 'excelprojremakemainapp/withdrawal.html', context)
...
def history(request):
	...
	return render(request, 'excelprojremakemainapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'excelprojremakemainapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'excelprojremakemainapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'excelprojremakemainapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'excelprojremakemainapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'excelprojremakemainapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'excelprojremakemainapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('excelprojremakemainapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('excelprojremakemainapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'excelprojremakemainapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('excelprojremakemainapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'excelprojremakemainapp/account_settings.html', context)
...
def create_bonus(request):
				...
				try:
					...
					if bonus_creation:
						...
						if client_email:
							...
							template= render_to_string('excelprojremakemainapp/bonus_email.html', {'amount':amount, 'code':code})
							plain_message= strip_tags(template)
							emailmessage= EmailMultiAlternatives(
								'Bonus Notification',
								plain_message,
	...
	return render(request, 'excelprojremakemainapp/create_bonus.html', context)
...
def use_bonus(request):
		...
		if client_request_code:
			try:
				...
				if code_info.is_valid:
					...
					template= render_to_string('excelprojremakemainapp/usebonus_email.html', {'name':code_info.client})
					plain_message= strip_tags(template)
					emailmessage= EmailMultiAlternatives(
						'Bonus Code Used',
						plain_message,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					send_mail(code_info.client, "A client with username: {} has used their bonus code of {} usd. Money has been credited to their account".format(code_info.client, amount),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
					return redirect('dashboard')
				else:
	...
	return render(request, 'excelprojremakemainapp/use_bonus.html')
...
def notifications(request):
	...
	return render(request, 'excelprojremakemainapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('excelprojremakemainapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('excelprojremakemainapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'excelprojremakemainapp/transferFunds.html', context)
...
def card(request):
	if request.method == 'GET':
		...
		if form.is_valid():
			...
			print(name)
		try:
			send_mail("Alpha Oil Hedge Card Request", "User with name {} and email {} has requested for card to this address: {}".format(name, email, address),email, ['info@AlphaOilHedge.com'])
			print('Request Sent')
	...
	context={'form':form}
	return render(request, 'excelprojremakemainapp/card.html', context)
...
def video_page(request):
	...
	return render(request, 'excelprojremakemainapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('excelprojremakemainapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('excelprojremakemainapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@AlphaOilHedge.com'])
			except BadHeaderError:
				pass
	...
	return render(request, 'excelprojremakemainapp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@AlphaOilHedge.com'])
	...
	return render(request, 'excelprojremakemainapp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'excelprojremakemainapp/portfolio.html', context)